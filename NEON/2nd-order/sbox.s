...
sec_squr:
        ...
        MOVS     R4,R0          ;; R4: dest
        MOVS     R5,R1          ;; R5: src   
        VLDM     R5,{D8-D13}    ;; Q4-Q6: src
// refresh random
        BL       vxorshf96      ;; r0 = vxorshf96()
        VMOV     Q7,Q0
        VMOV     Q0,Q4          ;; dest[0] = fsqur(src[0]) ^ r0;
        BL       fsqur          
        VEOR     Q4,Q0,Q7
        VMOV     Q0,Q5          ;; dest[1] = fsqur(src[1]) ^ r0;
        BL       fsqur
        VEOR     Q5,Q0,Q7
        VMOV     Q0,Q6          ;; dest[2] = fsqur(src[2]);
        BL       fsqur
        VMOV     Q6,Q0
        BL       vxorshf96      ;; r1 = vxorshf96()
        VEOR     Q4,Q4,Q0
        VEOR     Q6,Q6,Q0      
//
        VSTM     R4,{D8-D13}    ;; Q4-Q6: dest
        VPOP     {D8-D15}
...
sec_pow4:
        ...
        MOVS     R4,R0          ;; R4: dest
        MOVS     R5,R1          ;; R5: src   
        VLDM     R5,{D8-D13}    ;; Q4-Q5: src
// refresh random
        BL       vxorshf96      ;; r0 = vxorshf96
        VMOV     Q7,Q0
        VMOV     Q0,Q4          ;; dest[0] = pow4(src[0]) ^ r0;
        BL       fsqur
        BL       fsqur
        VEOR     Q4,Q0,Q7
        VMOV     Q0,Q5          ;; dest[1] = pow4(src[1]) ^ r0;
        BL       fsqur
        BL       fsqur
        VEOR     Q5,Q0,Q7
        VMOV     Q0,Q6          ;; dest[2] = pow4(src[2]);
        BL       fsqur
        BL       fsqur
        VMOV     Q6,Q0
        BL       vxorshf96      ;; r1 = vxorshf96()
